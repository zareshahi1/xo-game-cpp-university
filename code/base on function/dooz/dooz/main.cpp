...
int main() {
	...
	for (i = 0; i<6; i++) {
		...
		center_horizontal();	cout << "\t  8b        d8\n";
		center_horizontal();	cout << "\t   Y8,    ,8P \n";
		center_horizontal();	cout << "\t    `8b  d8'  \n";
		center_horizontal();	cout << "\t      Y88P    \n";
		center_horizontal();	cout << "\t      d88b    \n";
		center_horizontal();	cout << "\t    ,8P  Y8,  \n";
		center_horizontal();	cout << "\t   d8'    `8b \n";
		center_horizontal();	cout << "\t  8P        Y8\n\n\n";
		SetConsoleTextAttribute(hConsole, c);
		center_horizontal();	cout << "\t   ,ad8888ba,  \n";
		center_horizontal();	cout << "\t  d8'      `8b \n";
		center_horizontal();	cout << "\t d8'        `8b\n";
		center_horizontal();	cout << "\t 88          88\n";
		center_horizontal();	cout << "\t 88          88\n";
		center_horizontal();	cout << "\t Y8,        ,8P\n";
		center_horizontal();	cout << "\t  Y8a.    .a8P \n";
		center_horizontal();	cout << "\t    YY8888YY   \n\n\n";
...
int menu() {
	...
	center_vertical();
	cout << "\n\n\n\n\n";
	center_horizontal(); cout << "        choose a number :\n";
	center_horizontal(); cout << "_________________________________\n\n";
	center_horizontal(); cout << "          1-start new game\n\n";
	center_horizontal(); cout << "          2-continue game\n\n";
	center_horizontal(); cout << "          3-change theme\n\n";
	center_horizontal(); cout << "          4-leader board\n\n";
	center_horizontal(); cout << "          5-exit\n";
	center_horizontal(); cout << "_________________________________\n";
...
void choose_play_type() {
	...
	center_horizontal(); cout << "        choose a number :\n";
	center_horizontal(); cout << "_________________________________\n\n";
	center_horizontal(); cout << "         1 - singleplay\n\n";
	center_horizontal(); cout << "         2 - multiplay\n";
	center_horizontal(); cout << "_________________________________\n\n";
	center_horizontal(); cout << "     enter your selection : ";
	while (1) {
		f = getche();
		if (f == '1') {
			level();
...
void choose_multiplay() {
	...
	center_horizontal();	cout << "\t    is first\n";
...
void game_multiplay(int b) {
	gametype = 2;
	save_o();
	view(color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red);
	check(2);
	if (b == 1) {
		SetConsoleTextAttribute(hConsole, color.red);
		cout << "\n\n\n\n\t\t\t\t\t\t\t" << "red";
...
void view(int b1, int r1, int b2, int r2, int b3, int r3, int b4, int r4, int b5, int r5, int b6, int r6, int b7, int r7, int b8, int r8, int b9, int r9) {
	system("cls");
	printf("\n\n");
	/*if (x==1)cout<<"blue";
	if (x==0)cout<<"red";*/
	system((color.theme).c_str());
	center_vertical(); center_horizontal1();
	//1---------------------------------------------------------------------------
	//1-line0
	if (a[0][0] == 'O') {
...
void playnum1() {
	...
	{
		printf("\n\n\n\n\t\t\t\t\t\t2 bare talash konid\n\t\t\t\t\tpress any key and keep on the game");   getche(); game_multiplay(1);
	}
}
void playnum2() {
	char e;
	...
	{
		printf("\n\n\n\n\t\t\t\t\t\t2 bare talash konid\n\t\t\t\t\tpress any key and keep on the game");   getche(); game_multiplay(0);
	}
}
void playme() {
	char e;
	...
	{
		printf("\n\n\n\n\t\t\t\t\t\t2 bare talash konid\n\t\t\t\t\tpress any key and keep on the game");   getche(); game(0);
	}
}
void check(int k) {
	int i;
	...
	for (i = 0; i<3; i++)
	{
		if (a[i][0] == 'O' && a[i][1] == 'O' && a[i][2] == 'O')
		{
			system("cls");
			if (i == 0)
				view(color.blue_win, color.red, color.blue_win, color.red, color.blue_win, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red);
			if (i == 1)
				view(color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue_win, color.red, color.blue_win, color.red, color.blue_win, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red);
			if (i == 2)
				view(color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue_win, color.red, color.blue_win, color.red, color.blue_win, color.red);
			this_thread::sleep_for(chrono::milliseconds(1500));
			system("cls");
			if (k == 1) {
				win_graph(1);
				this_thread::sleep_for(chrono::milliseconds(1500));   replay();
			}
			if (k == 2) {
				win_graph(3);
				this_thread::sleep_for(chrono::milliseconds(1500));	replay_multiplay();
			}
		}
	}
	// You & num 2 <vertical> 
	for (i = 0; i < 3; i++)
	{
		if (a[0][i] == 'O' && a[1][i] == 'O' && a[2][i] == 'O')
		{
			system("cls");
			if (i == 0)
				view(color.blue_win, color.red, color.blue, color.red, color.blue, color.red, color.blue_win, color.red, color.blue, color.red, color.blue, color.red, color.blue_win, color.red, color.blue, color.red, color.blue, color.red);
			if (i == 1)
				view(color.blue, color.red, color.blue_win, color.red, color.blue, color.red, color.blue, color.red, color.blue_win, color.red, color.blue, color.red, color.blue, color.red, color.blue_win, color.red, color.blue, color.red);
			if (i == 2)
				view(color.blue, color.red, color.blue, color.red, color.blue_win, color.red, color.blue, color.red, color.blue, color.red, color.blue_win, color.red, color.blue, color.red, color.blue, color.red, color.blue_win, color.red);
			this_thread::sleep_for(chrono::milliseconds(1500));
			system("cls");
			if (k == 1) {
				win_graph(1);
	...
	if ((a[0][0] == 'O' && a[1][1] == 'O' && a[2][2] == 'O') || (a[0][2] == 'O' && a[1][1] == 'O' && a[2][0] == 'O')) {
		...
		if (a[0][0] == 'O' && a[1][1] == 'O' && a[2][2] == 'O')
			view(color.blue_win, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue_win, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue_win, color.red);
		if (a[0][2] == 'O' && a[1][1] == 'O' && a[2][0] == 'O')
			view(color.blue, color.red, color.blue, color.red, color.blue_win, color.red, color.blue, color.red, color.blue_win, color.red, color.blue, color.red, color.blue_win, color.red, color.blue, color.red, color.blue, color.red);
		this_thread::sleep_for(chrono::milliseconds(1500));
		system("cls");
		if (k == 1) {
			win_graph(1);
	...
	for (i = 0; i < 3; i++)
	{
		if (a[i][0] == 'X' && a[i][1] == 'X' && a[i][2] == 'X') {
			system("cls");
			if (i == 0) //line 1
				view(color.blue, color.red_win, color.blue, color.red_win, color.blue, color.red_win, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red);
			if (i == 1) //line 2
				view(color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red_win, color.blue, color.red_win, color.blue, color.red_win, color.blue, color.red, color.blue, color.red, color.blue, color.red);
			if (i == 2) //line 3
				view(color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red_win, color.blue, color.red_win, color.blue, color.red_win);
			this_thread::sleep_for(chrono::milliseconds(1500));
			system("cls");
			if (k == 1) {
				win_graph(2);
	...
	for (i = 0; i<3; i++)
	{
		if (a[0][i] == 'X' && a[1][i] == 'X' && a[2][i] == 'X') {
			system("cls");
			if (i == 0)
				view(color.blue, color.red_win, color.blue, color.red, color.blue, color.red, color.blue, color.red_win, color.blue, color.red, color.blue, color.red, color.blue, color.red_win, color.blue, color.red, color.blue, color.red);
			if (i == 1)
				view(color.blue, color.red, color.blue, color.red_win, color.blue, color.red, color.blue, color.red, color.blue, color.red_win, color.blue, color.red, color.blue, color.red, color.blue, color.red_win, color.blue, color.red);
			if (i == 2)
				view(color.blue, color.red, color.blue, color.red, color.blue, color.red_win, color.blue, color.red, color.blue, color.red, color.blue, color.red_win, color.blue, color.red, color.blue, color.red, color.blue, color.red_win);
			this_thread::sleep_for(chrono::milliseconds(1500));
			system("cls");
			if (k == 1) {
				win_graph(2);
	...
	if ((a[0][2] == 'X' && a[1][1] == 'X' && a[2][0] == 'X') || (a[0][0] == 'X' && a[1][1] == 'X' && a[2][2] == 'X')) {
		if (a[0][0] == 'X' && a[1][1] == 'X' && a[2][2] == 'X')
			view(color.blue, color.red_win, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red_win, color.blue, color.red, color.blue, color.red, color.blue, color.red, color.blue, color.red_win);
		if (a[0][2] == 'X' && a[1][1] == 'X' && a[2][0] == 'X')
			view(color.blue, color.red, color.blue, color.red, color.blue, color.red_win, color.blue, color.red, color.blue, color.red_win, color.blue, color.red, color.blue, color.red_win, color.blue, color.red, color.blue, color.red);
		this_thread::sleep_for(chrono::milliseconds(1500));
		system("cls");
		if (k == 1) {
			win_graph(2);
...
void choose_theme() {
	...
	center_horizontal(); cout << "         choose a number :\n";
	center_horizontal(); cout << "_________________________________\n\n\n";
	center_horizontal(); cout << "             1-Black\n\n";
	center_horizontal(); cout << "             2-White\n\n";
	center_horizontal(); cout << "_________________________________\n";
...
void load_o_menu() {
	...
	center_horizontal(); cout << "        choose a number :\n";
	center_horizontal(); cout << "_________________________________\n\n";
	center_horizontal(); cout << "          1-load singleplay\n\n";
	center_horizontal(); cout << "          2-load multiplay\n\n";
	center_horizontal(); cout << "_________________________________\n";
	while (1) {
		f = getch();
		if (f == '1') {
